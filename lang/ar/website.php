...
return [
    ...
    'seo' => [
        'default_description' => 'استأجر سيارات فاخرة ورياضية ودفع رباعي واقتصادية بخطط يومية وأسبوعية وشهرية مرنة من أفندينا لتأجير السيارات.',
        'cars_description' => 'تصفح السيارات المتاحة للإيجار حسب العلامة التجارية والفئة وسنة الصنع مع أسعار يومية وأسبوعية وشهرية مرنة.',
        'blog_description' => 'اطلع على أحدث نصائح تأجير السيارات وأخبار السفر وأخبار الأسطول من أفندينا لتأجير السيارات.',
    ],
    ...
    'search' => [
        'title' => 'ابحث عن سيارة',
        'open' => 'فتح بحث السيارات',
        'input_label' => 'بحث السيارات',
        'placeholder' => 'ابحث بالعلامة أو الموديل أو كلمة مفتاحية',
        'submit' => 'بحث',
        'page_title' => 'بحث السيارات',
        'breadcrumb' => 'بحث',
        'results_title' => 'نتائج البحث عن ":query"',
        'meta_description' => 'ابحث في السيارات المتاحة للإيجار حسب العلامة أو الموديل أو الفئة أو الكلمة المفتاحية.',
    ],
    ...
    'car_details' => [
        ...
        'whatsapp_inquiry' => [
            'intro' => 'مرحبًا، لقد أرسلت استفسارًا عبر Afandinaبخصوص هذا التأجير:',
            'price_label' => 'السعر',
            'listing_link_label' => 'رابط الإعلان',
            'outro' => 'أود معرفة المزيد من التفاصيل. هل هي متاحة في...',
            'day' => 'يوم',
            'week' => 'أسبوع',
            'month' => 'شهر',
        ],
