            ...
            <form action="<?php echo e(route('admin.' . $modelName . '.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel"
                        ...
                        <select name="for" id="for" class="form-control form-control-lg shadow-sm select2" data-placeholder="<?php echo e(__('Select document audience')); ?>">
                            <option value=""><?php echo e(__('Select Document For')); ?></option>
                            <option value="native" <?php echo e(old('for') == 'native' ? 'selected' : ''); ?>>
                                <?php echo e(__('Native')); ?>

                            </option>

                            <option value="foreign" <?php echo e(old('for') == 'foreign' ? 'selected' : ''); ?>>
                                <?php echo e(__('Foreign')); ?>
                            ...
                            <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="pills-<?php echo e($lang->code); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="content[<?php echo e($lang->code); ?>]"
                                            class="form-control form-control-lg shadow-sm" id="content_<?php echo e($lang->code); ?>"
                                            value="<?php echo e(old('content.' . $lang->code)); ?>">
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/documents/create.blade.php ENDPATH**/ ?>