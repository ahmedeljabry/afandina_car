<?php $__env->startSection('title', __('Create Car')); ?>
<?php $__env->startSection('page-title', __('Create Car')); ?>
...
<?php $__env->startSection('page-actions'); ?>
    <a href="<?php echo e(route('admin.cars.index')); ?>" class="btn btn-outline-secondary d-inline-flex align-items-center">
        ...
        <section class="car-workbench__hero">
            <div class="car-workbench__hero-copy">
                ...
                <p class="car-workbench__subtitle">
                    <?php echo e(__('The old layout is gone. This new workspace is built for faster entry: start with core specs, move through translations, then finish with SEO and publish when the listing is complete.')); ?>

                </p>
                <div class="car-workbench__hero-tags">
                    <span class="car-workbench__tag"><?php echo e(__('3-stage workflow')); ?></span>
                    <?php if($languageCount): ?>
                        <span class="car-workbench__tag"><?php echo e(__(':count locales', ['count' => $languageCount])); ?></span>
                    <?php endif; ?>
                    <span class="car-workbench__tag"><?php echo e(__('Media uploads ready')); ?></span>
                </div>
            </div>
            <div class="car-workbench__hero-cards">
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Stage 1')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e(__('Vehicle setup')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Specs, pricing, media, and switches')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Stage 2')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e(__('Localized copy')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Manual or AI-generated content')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Stage 3')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e(__('SEO finishing')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Metadata, robots, and Q&A')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Goal')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e(__('Publish cleanly')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('One focused screen for the full flow')); ?></span>
                </div>
            </div>
        </section>
            ...
            <aside class="car-workbench__aside">
                <div class="car-workbench__panel">
                    <div class="car-workbench__panel-head">
                        ...
                        <div>
                            <h3 class="car-workbench__panel-title"><?php echo e(__('Build Flow')); ?></h3>
                            <p class="car-workbench__panel-copy"><?php echo e(__('Use the tabs as a guided path instead of jumping around the page.')); ?></p>
                        </div>
                    </div>
                    <ul class="car-workbench__steps">
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('General')); ?></span>
                            <span class="car-workbench__step-text"><?php echo e(__('Set brand, model, pricing, features, media, and status first.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('Translations')); ?></span>
                            <span class="car-workbench__step-text"><?php echo e(__('Fill language-specific name, summary, and long description.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('SEO')); ?></span>
                            <span class="car-workbench__step-text"><?php echo e(__('Add metadata, search directives, and question blocks last.')); ?></span>
                        </li>
                    </ul>
                </div>
                <div class="car-workbench__panel">
                    <div class="car-workbench__panel-head">
                        ...
                        <div>
                            <h3 class="car-workbench__panel-title"><?php echo e(__('Quick Notes')); ?></h3>
                            <p class="car-workbench__panel-copy"><?php echo e(__('A few practical reminders before you save the listing.')); ?></p>
                        </div>
                    </div>
                    <ul class="car-workbench__facts">
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('Media')); ?></span>
                            <span class="car-workbench__fact-value"><?php echo e(__('Upload a default cover image before adding the gallery.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('AI')); ?></span>
                            <span class="car-workbench__fact-value"><?php echo e(__('Use generated text as a draft, then review before publishing.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('Publish')); ?></span>
                            <span class="car-workbench__fact-value"><?php echo e(__('Leave inactive until pricing and translations are reviewed.')); ?></span>
                        </li>
                    </ul>
                </div>
            </aside>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="category_ids[]" id="category_id" class="form-control shadow-sm select2 <?php $__errorArgs = ['category_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple="multiple">
                                                                ...
                                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($category->id); ?>" <?php echo e(in_array($category->id, (array) old('category_ids', [])) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="is_popular" class="custom-control-input" id="is_popular" <?php echo e(old('is_popular') ? 'checked' : ''); ?>>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-translated" role="tabpanel" aria-labelledby="custom-tabs-translated-tab">
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php if($loop->first): ?> active <?php endif; ?> bg-light text-dark" id="pills-<?php echo e($lang->code); ?>-tab" data-bs-toggle="pill" href="#pills-<?php echo e($lang->code); ?>" role="tab" aria-controls="pills-<?php echo e($lang->code); ?>" aria-selected="true"><?php echo e($lang->name); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="long_description[<?php echo e($lang->code); ?>]" class="form-control form-control-lg shadow-sm tinymce <?php $__errorArgs = ['long_description.'.$lang->code];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-seo" role="tabpanel" aria-labelledby="custom-tabs-seo-tab">
                                    <ul class="nav nav-pills mb-3" id="pills-seo-tab" role="tablist">
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php if($loop->first): ?> active <?php endif; ?> bg-light text-dark" id="pills-seo-<?php echo e($lang->code); ?>-tab" data-bs-toggle="pill" href="#pills-seo-<?php echo e($lang->code); ?>" role="tab" aria-controls="pills-seo-<?php echo e($lang->code); ?>" aria-selected="true"><?php echo e($lang->name); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var initialModelId = '<?php echo e(old('car_model_id')); ?>';
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\cars\create.blade.php ENDPATH**/ ?>