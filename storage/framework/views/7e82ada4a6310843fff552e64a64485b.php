                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel"
                        ...
                        <select name="for" id="for" class="form-control form-control-lg shadow-sm select2" data-placeholder="<?php echo e(__('Select document audience')); ?>">
                            ...
                            <option value="native" <?php echo e($item->for == 'native' ? 'selected' : ''); ?>>
                                <?php echo e(__('Native')); ?>

                            </option>

                            <option value="foreign" <?php echo e($item->for == 'foreign' ? 'selected' : ''); ?>>
                                ...
                                <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="pills-<?php echo e($lang->code); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="content[<?php echo e($lang->code); ?>]"
                                            ...
                                            value="<?php echo e(old('content.' . $lang->code, $translation->content ?? '')); ?>">
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\documents\edit.blade.php ENDPATH**/ ?>