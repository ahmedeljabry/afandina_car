...
<div class="border rounded p-4 mb-4">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-4">
        <div>
            <h5 class="mb-1"><?php echo e($lang->name); ?></h5>
            <p class="text-muted mb-0">Homepage text for the `<?php echo e($lang->code); ?>` locale.</p>
        </div>
        <span class="badge badge-light border text-dark"><?php echo e(strtoupper($lang->code)); ?></span>
    </div>

    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card border shadow-sm mb-4">
            <div class="card-header bg-white">
                <h6 class="mb-1"><?php echo e($section['title']); ?></h6>
            ...
            <div class="card-body">
                <div class="row">
                    <?php $__currentLoopData = $section['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="<?php echo e($fieldWidth); ?> mb-3">
                            <label for="<?php echo e($fieldName); ?>_<?php echo e($lang->code); ?>" class="font-weight-bold"><?php echo e($field['label']); ?></label>
                            <?php if($fieldType === 'textarea'): ?>
                                <textarea
                                    name="<?php echo e($fieldName); ?>[<?php echo e($lang->code); ?>]"
                                    id="<?php echo e($fieldName); ?>_<?php echo e($lang->code); ?>"
                                    class="form-control <?php $__errorArgs = [$fieldName . '.' . $lang->code];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                >
                            <?php endif; ?>
                            <?php $__errorArgs = [$fieldName . '.' . $lang->code];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
    ...
    <div class="card border shadow-sm mb-0">
        ...
        <div class="card-body">
            <div class="form-group">
                <label for="meta_title_<?php echo e($lang->code); ?>" class="font-weight-bold">Meta Title</label>
                <input
                    type="text"
                    name="meta_title[<?php echo e($lang->code); ?>]"
                    id="meta_title_<?php echo e($lang->code); ?>"
                    class="form-control <?php $__errorArgs = ['meta_title.' . $lang->code];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="meta_description_<?php echo e($lang->code); ?>" class="font-weight-bold">Meta Description</label>
                <textarea
                    name="meta_description[<?php echo e($lang->code); ?>]"
                    id="meta_description_<?php echo e($lang->code); ?>"
                    class="form-control <?php $__errorArgs = ['meta_description.' . $lang->code];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    rows="3"
                ><?php echo e(old('meta_description.' . $lang->code, $translation?->meta_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="meta_keywords_<?php echo e($lang->code); ?>" class="font-weight-bold">Meta Keywords</label>
                <input
                    type="text"
                    name="meta_keywords[<?php echo e($lang->code); ?>]"
                    id="meta_keywords_<?php echo e($lang->code); ?>"
                    class="form-control <?php $__errorArgs = ['meta_keywords.' . $lang->code];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('meta_keywords.' . $lang->code, $metaKeywordsValue)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="border rounded p-3 h-100">
                        <div class="form-check">
                            <input
                                ...
                                value="index"
                                <?php if(old('robots_index.' . $lang->code, $translation?->robots_index ?? '') === 'index'): echo 'checked'; endif; ?>
                            >
                            <label class="form-check-label font-weight-bold" for="robots_index_<?php echo e($lang->code); ?>">Allow indexing</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border rounded p-3 h-100">
                        <div class="form-check">
                            <input
                                ...
                                value="follow"
                                <?php if(old('robots_follow.' . $lang->code, $translation?->robots_follow ?? '') === 'follow'): echo 'checked'; endif; ?>
                            >
                            <label class="form-check-label font-weight-bold" for="robots_follow_<?php echo e($lang->code); ?>">Allow link follow</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-3">
                ...
                <button type="button" class="btn btn-sm btn-outline-primary add-seo-question" data-lang="<?php echo e($lang->code); ?>">Add Question</button>
            </div>

            <div class="seo-questions-container" id="seo-questions-<?php echo e($lang->code); ?>">
                <?php $__empty_1 = true; $__currentLoopData = $seoQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $seoQuestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="seo-question-group border rounded p-3 mb-3">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="3"
                            ><?php echo e(old('seo_questions.' . $lang->code . '.' . $index . '.answer', $seoQuestion->answer_text)); ?></textarea>
                        </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="seo-question-group border rounded p-3 mb-3">
                        <div class="form-group">
                            ...
                            <input
                                type="text"
                                name="seo_questions[<?php echo e($lang->code); ?>][0][question]"
                                class="form-control"
                                value="<?php echo e(old('seo_questions.' . $lang->code . '.0.question')); ?>"
                            >
                        </div>
                        <div class="form-group mb-2">
                            <label class="font-weight-bold">Answer</label>
                            <textarea
                                name="seo_questions[<?php echo e($lang->code); ?>][0][answer]"
                                class="form-control"
                                rows="3"
                            ><?php echo e(old('seo_questions.' . $lang->code . '.0.answer')); ?></textarea>
                        </div>
                        <button type="button" class="btn btn-sm btn-outline-danger remove-seo-question">Remove</button>
                    </div>
                <?php endif; ?>
...
<?php /**PATH D:\afandina\resources\views\pages\admin\homes\partials\language-panel.blade.php ENDPATH**/ ?>