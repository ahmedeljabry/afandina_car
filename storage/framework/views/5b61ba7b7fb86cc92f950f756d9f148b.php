    ...
    <div class="management-hero">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p><?php echo e(__('Curate the short-form stories that keep visitors inspired.')); ?></p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-layer-group"></i> <?php echo e($totalItems); ?> <?php echo e(__('videos')); ?>
    ...
    <div class="card management-card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                <div>
                    <h4 class="mb-1"><?php echo e($modelName); ?> <?php echo e(__('Library')); ?></h4>
                    <p class="text-muted mb-0"><?php echo e(__('Search, sort and moderate the video gallery with ease.')); ?></p>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="text-muted"><?php echo e(__('No video uploaded')); ?></span>
                                    <?php endif; ?>
                                </td>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="empty-row">
                                <td colspan="6" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle mr-1"></i> <?php echo e(__('No videos found yet.')); ?>
    ...
    <script>
        $(function () {
            ...
            $table.DataTable({
                ...
                language: {
                    search: "",
                    searchPlaceholder: "<?php echo e(__('Search videos')); ?>",
                    ...
                    zeroRecords: "<?php echo e(__('No matching videos found')); ?>",
                    paginate: {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/short_videos/index.blade.php ENDPATH**/ ?>