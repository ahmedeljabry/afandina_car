<?php $__env->startSection('title', $homeTranslation?->contact_us_title ?? __('website.contact.page_title')); ?>
        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title"><?php echo e($pageTitle); ?></h2>
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('website.nav.home')); ?></a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><?php echo e(__('website.contact.breadcrumb.pages')); ?></a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="0.1">
                        <div class="single-contact-info flex-fill">
                            ...
                            <h3><?php echo e(__('website.contact.cards.phone_number')); ?></h3>
                            <a href="<?php echo e($phoneHref); ?>"><?php echo e($phoneNumber ?: __('website.contact.fallback.not_available')); ?></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="0.2">
                        <div class="single-contact-info flex-fill">
                            <span><i class="feather-mail"></i></span>
                            <h3><?php echo e(__('website.contact.cards.email_address')); ?></h3>
                            <a href="<?php echo e($emailHref); ?>"><?php echo e($email ?: __('website.contact.fallback.not_available')); ?></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="0.3">
                        <div class="single-contact-info flex-fill">
                            <span><i class="feather-map-pin"></i></span>
                            <h3><?php echo e(__('website.contact.cards.location')); ?></h3>
                            <a href="<?php echo e($locationHref); ?>" <?php if($locationHref !== 'javascript:void(0);'): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>><?php echo e($fullAddress ?: __('website.contact.fallback.not_available')); ?></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="0.4">
                        <div class="single-contact-info flex-fill">
                            <span><i class="feather-clock"></i></span>
                            <h3><?php echo e(__('website.contact.cards.opening_hours')); ?></h3>
                            <a href="javascript:void(0);"><?php echo e($detailsParagraph); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-info-area" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="0.5">
                <div class="row">
                    <div class="col-lg-6 d-flex">
                        <img src="<?php echo e($assetUrl('img/contact-info.jpg')); ?>" class="img-fluid" alt="Contact">
                    </div>
                    <div class="col-lg-6">
                        <form action="<?php echo e(route('website.contact.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="input-block">
                                        <label><?php echo e(__('website.contact.form.phone_number')); ?> <span class="text-danger">*</span></label>
                                        <input type="text"
                                            name="phone"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="input-block">
                                        <label><?php echo e(__('website.contact.form.comments')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button class="btn contact-btn" type="submit"><?php echo e(__('website.contact.form.send_enquiry')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\website\contact-us.blade.php ENDPATH**/ ?>