                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th> وصف  <?php echo e($modelName); ?> (بالإنجليزية):</th>
                                            <td><?php echo e($item->description_en); ?></td>
                                        </tr>
                                        <tr>
                                            <th> وصف  <?php echo e($modelName); ?> (بالعربية):</th>
                                            <td><?php echo e($item->description_ar); ?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($item->category_image): ?>
                                                    <img src="<?php echo e(asset('storage/' . $item->category_image)); ?>" alt="<?php echo e($modelName); ?> image" class="brand-logo img-thumbnail" style="max-height: 100px;">
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\old\categories\show.blade.php ENDPATH**/ ?>