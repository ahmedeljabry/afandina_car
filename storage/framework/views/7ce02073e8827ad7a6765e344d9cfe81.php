    ...
    <div class="card management-card">
        ...
        <div class="card-body pt-1">
            <div class="table-responsive">
                <table id="categories-table" class="table table-hover table-striped table-modern w-100 datatable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->image_path)); ?>" alt="category_image" class="img-"
                                ...
                                <td><?php echo e($item->translations->first()->description ?? 'N/A'); ?></td>
                                <td>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\categories\index.blade.php ENDPATH**/ ?>