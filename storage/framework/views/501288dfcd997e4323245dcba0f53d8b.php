                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel"
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="color_code" class="form-control form-control-lg shadow-sm"
                                id="color_code" value="<?php echo e($item->color_code); ?>">
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\colors\edit.blade.php ENDPATH**/ ?>