                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control"
                                        value="<?php echo e(old('order', 0)); ?>" required>
                        ...
                        <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded" id="pills-tabContent">
                            <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="pills-<?php echo e($lang->code); ?>"
                                    ...
                                    <div class="form-group">
                                        <label for="question_<?php echo e($lang->code); ?>" class="font-weight-bold">Question
                                            (<?php echo e($lang->name); ?>)</label>
                                        <input type="text" name="question[<?php echo e($lang->code); ?>]"
                                            class="form-control form-control-lg shadow-sm" id="question_<?php echo e($lang->code); ?>"
                                            value="<?php echo e(old('question.' . $lang->code)); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="answer_<?php echo e($lang->code); ?>" class="font-weight-bold">Answer
                                            (<?php echo e($lang->name); ?>)</label>
                                        <textarea name="answer[<?php echo e($lang->code); ?>]"
                                            class="form-control form-control-lg shadow-sm" id="answer_<?php echo e($lang->code); ?>"
                                            rows="4"><?php echo e(old('answer.' . $lang->code)); ?></textarea>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\faqs\create.blade.php ENDPATH**/ ?>