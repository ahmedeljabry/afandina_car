...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            <img id="imagePreview" src="<?php echo e(asset('storage/' . $item->logo_path)); ?>" alt="Image Preview" class="brand-logo img-thumbnail" style="max-height: 100px;">
                                        </div>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\old\brands\edit.blade.php ENDPATH**/ ?>