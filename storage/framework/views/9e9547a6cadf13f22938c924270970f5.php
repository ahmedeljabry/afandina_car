                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="mb-3">
                                <img id="imagePreviewLogo"
                                    src="<?php echo e($item->image_path ? asset('storage/' . $item->image_path) : 'data:image/svg+xml;charset=UTF-8,%3Csvg width=\'600\' height=\'200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Crect width=\'600\' height=\'200\' fill=\'%23cccccc\'/%3E%3Ctext x=\'300\' y=\'100\' fill=\'%23333333\' text-anchor=\'middle\' alignment-baseline=\'middle\' font-size=\'16\'%3ENo Image Selected%3C/text%3E%3C/svg%3E'); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\services\edit.blade.php ENDPATH**/ ?>