<?php $__env->startSection('title', 'Manage Car Media'); ?>

<?php $__env->startSection('page-title'); ?>
    Manage Media for Car ID: <?php echo e($item->id); ?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body p-2">
            <div class="row" id="media-container">
                <?php $__currentLoopData = $item->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-sm-6">
                        <div class="media-card">
                            <label class="custom-checkbox">
                                <input type="checkbox" class="media-checkbox" data-media-id="<?php echo e($media->id); ?>">
                                <span class="checkmark"></span>
                            </label>
                            <div class="card-img-wrapper">
                                <img src="<?php echo e(asset('storage/' . $media->file_path)); ?>" alt="Car Image">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div id="defaultImagePreview" class="mt-3">
                        <?php if($item->default_image_path): ?>
                            <img src="<?php echo e(asset('storage/' . $item->default_image_path)); ?>" alt="Default Image"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function deleteAll() {
            ...
            axios.post('/admin/cars/delete-all-images/' + <?php echo e($item->id); ?>)
                .then(response => {
                    if (response.data.success) {
                        window.location.reload();
                    } else {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            mediaUploadForm.addEventListener('submit', async function (e) {
                ...
                try {
                    const response = await axios.post(`/cars/<?php echo e($item->id); ?>/upload-image`, formData, {
            ...
            defaultImageForm.addEventListener('submit', async function (e) {
                ...
                try {
                    const response = await axios.post(`/cars/<?php echo e($item->id); ?>/upload-default-image`, formData, {
                        headers: { 'Content-Type': 'multipart/form-data' },
                        onUploadProgress: (progressEvent) => {
                            const percentCompleted = Math.round((progressEvent.loaded * 100) / progressEvent.total);
                            if (progressBar) {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\cars\edit_images.blade.php ENDPATH**/ ?>