    ...
    <div class="management-hero">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p><?php echo e(__('Ensure campaigns stay refreshed across mobile and desktop placements.')); ?></p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-bullhorn"></i> <?php echo e($totalItems); ?> <?php echo e(__('ads')); ?>

                </span>
                <span class="stat-pill">
                    <i class="fas fa-map-marker-alt"></i> <?php echo e($positions); ?> <?php echo e(__('positions')); ?>
    ...
    <div class="card management-card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                <div>
                    <h4 class="mb-1"><?php echo e($modelName); ?> <?php echo e(__('Placements')); ?></h4>
                    <p class="text-muted mb-0"><?php echo e(__('Compare creatives, slots, and statuses side by side.')); ?></p>
                </div>
                ...
                <table id="advertisements-table" class="table table-hover table-striped management-table w-100">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th><?php echo e(__('Mobile Image')); ?></th>
                            <th><?php echo e(__('Web Image')); ?></th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($item->mobile_image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->mobile_image_path)); ?>" alt="<?php echo e(__('Mobile creative')); ?>" class="media-thumb">
                                    <?php else: ?>
                                        <span class="text-muted"><?php echo e(__('N/A')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($item->web_image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->web_image_path)); ?>" alt="<?php echo e(__('Web creative')); ?>" class="media-thumb">
                                    <?php else: ?>
                                        <span class="text-muted"><?php echo e(__('N/A')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-bold-600">
                                    <?php echo e($item->translations->first()->title ?? __('N/A')); ?>

                                </td>
                                <td>
                                    <span class="badge badge-light-info">
                                        <?php echo e($item->advertisementPosition->position_name ?? __('N/A')); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="empty-row">
                                <td colspan="8" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle mr-1"></i> <?php echo e(__('No advertisements found yet.')); ?>
    ...
    <script>
        $(function () {
            ...
            $table.DataTable({
                ...
                language: {
                    search: "",
                    searchPlaceholder: "<?php echo e(__('Search advertisements')); ?>",
                    ...
                    zeroRecords: "<?php echo e(__('No matching advertisements found')); ?>",
                    paginate: {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/advertisements/index.blade.php ENDPATH**/ ?>