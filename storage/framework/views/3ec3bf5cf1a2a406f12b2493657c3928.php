    ...
    <div class="card management-card">
        ...
        <div class="card-body pt-1">
            <div class="table-responsive">
                <table id="gear-types-table" class="table table-hover table-striped table-modern w-100 datatable">
                                ...
                                <td>
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" class="toggle-status" data-model="<?php echo e($modelName); ?>"
                                            data-id="<?php echo e($item->id); ?>" <?php echo e($item->is_active ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\gear_types\index.blade.php ENDPATH**/ ?>