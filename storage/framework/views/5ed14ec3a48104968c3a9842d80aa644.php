                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control"
                                        value="<?php echo e(old('order', $item->order)); ?>" required>
                                ...
                                <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="pills-<?php echo e($lang->code); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question[<?php echo e($lang->code); ?>]"
                                            ...
                                            value="<?php echo e(old('question.' . $lang->code, $translation->question ?? '')); ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="answer[<?php echo e($lang->code); ?>]"
                                            ...
                                            rows="4"><?php echo e(old('answer.' . $lang->code, $translation->answer ?? '')); ?></textarea>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\faqs\edit.blade.php ENDPATH**/ ?>