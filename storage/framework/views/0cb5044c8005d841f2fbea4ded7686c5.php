                            ...
                            <div class="listing-content">
                                ...
                                <div class="listing-button d-flex gap-2 home-featured-action-group">
                                    <a href="<?php echo e($whatsAppHref); ?>"
                                       class="btn btn-order flex-fill listing-action-btn <?php if($whatsAppHref === 'javascript:void(0);'): ?> disabled <?php endif; ?>"
                                       <?php if($whatsAppHref !== 'javascript:void(0);'): ?>
                                           target="_blank" rel="noopener noreferrer"
                                       <?php endif; ?>
                                       aria-disabled="<?php echo e($whatsAppHref === 'javascript:void(0);' ? 'true' : 'false'); ?>">
                                        <i class="fa-brands fa-whatsapp"></i>
                                        <span><?php echo e(__('website.car_details.owner_details.chat_whatsapp')); ?></span>
                                    </a>
                                    <a href="<?php echo e($phoneHref); ?>"
                                       class="btn btn-outline-dark flex-fill listing-action-btn <?php if($phoneHref === 'javascript:void(0);'): ?> disabled <?php endif; ?>"
                                       aria-disabled="<?php echo e($phoneHref === 'javascript:void(0);' ? 'true' : 'false'); ?>">
                                        <i class="fa-solid fa-phone"></i>
                                        <span><?php echo e(__('website.car_details.sidebar.call_us')); ?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
