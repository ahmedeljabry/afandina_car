                        ...
                        <div class="form-group">
                            ...
                            <select name="icon_id" id="icon_id" class="form-control shadow-sm select2">
                                ...
                                <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($icon->id); ?>" data-icon="<?php echo e($icon->icon_class); ?>" <?php echo e((old('icon_id', $item->icon_id) == $icon->id) ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\features\edit.blade.php ENDPATH**/ ?>