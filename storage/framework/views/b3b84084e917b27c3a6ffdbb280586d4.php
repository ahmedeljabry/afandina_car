                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="display: flex; align-items: center;">
                                        <!-- Color Box -->
                                        <span
                                            style="display: inline-block; width: 30px; height: 30px; background-color: <?php echo e($item->color_code); ?>; border: 1px solid #ddd; margin-right: 10px;"></span>
                                        <!-- Color Code -->
                                        <span><?php echo e($item->color_code); ?></span>
                                    </div>
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/colors/index.blade.php ENDPATH**/ ?>