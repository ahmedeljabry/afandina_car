    ...
    <div class="management-hero">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p><?php echo e(__('Keep support answers up to date and spotlight the most helpful ones.')); ?></p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-question-circle"></i> <?php echo e($totalItems); ?> <?php echo e(__('entries')); ?>

                </span>
                <span class="stat-pill">
                    <i class="fas fa-home"></i> <?php echo e($homeItems); ?> <?php echo e(__('home')); ?>
    ...
    <div class="card management-card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                <div>
                    <h4 class="mb-1"><?php echo e($modelName); ?> <?php echo e(__('Center')); ?></h4>
                    <p class="text-muted mb-0"><?php echo e(__('Organize by order, quickly edit answers, and manage visibility.')); ?></p>
                </div>
                ...
                <table id="faqs-table" class="table table-hover table-striped management-table w-100">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th><?php echo e(__('Show on Home')); ?></th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-light-primary"><?php echo e($item->order); ?></span>
                                </td>
                                <td class="text-bold-600">
                                    <?php echo e($item->translations->first()->question ?? __('N/A')); ?>

                                </td>
                                <td>
                                    <span class="text-muted">
                                        <?php echo e(\Illuminate\Support\Str::limit($item->translations->first()->answer ?? __('N/A'), 90)); ?>
                                ...
                                <td>
                                    <div class="toggle-label mb-25"><?php echo e(__('Show in Home')); ?></div>
                                    <label class="switch mb-0">
                                        <input type="checkbox"
                                               class="toggle-status"
                                               data-model="<?php echo e($modelName); ?>"
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="empty-row">
                                <td colspan="8" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle mr-1"></i> <?php echo e(__('No FAQs found yet.')); ?>
    ...
    <script>
        $(function () {
            ...
            $table.DataTable({
                ...
                language: {
                    search: "",
                    searchPlaceholder: "<?php echo e(__('Search FAQs')); ?>",
                    ...
                    zeroRecords: "<?php echo e(__('No matching FAQs found')); ?>",
                    paginate: {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/faqs/index.blade.php ENDPATH**/ ?>