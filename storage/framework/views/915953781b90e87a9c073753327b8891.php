<?php $__env->startSection('title', __('Edit Car')); ?>
<?php $__env->startSection('page-title', __('Edit Car')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('admin.cars.index')); ?>"><?php echo e(__('Cars')); ?></a>
    </li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Edit')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-actions'); ?>
    <a href="<?php echo e(route('admin.cars.index')); ?>" class="btn btn-outline-secondary d-inline-flex align-items-center me-2 mb-2">
        <i class="ti ti-arrow-left me-1"></i><?php echo e(__('Back to Cars')); ?>

    </a>
    <a href="<?php echo e(route('admin.cars.edit_images', $item->id)); ?>"
        class="btn btn-primary d-inline-flex align-items-center mb-2">
        <i class="ti ti-photo me-1"></i><?php echo e(__('Manage Images')); ?>
...
<?php echo $__env->make('includes.admin.car_form_rebuild', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="car-workbench">
        <section class="car-workbench__hero">
            <div class="car-workbench__hero-copy">
                <span class="car-workbench__eyebrow"><?php echo e(__('Car Studio')); ?></span>
                <h2 class="car-workbench__title"><?php echo e($formTitle); ?></h2>
                <p class="car-workbench__subtitle">
                    <?php echo e(__('This page has been rebuilt from the old design into a cleaner editing workspace. Review the listing in one place, update the core data, refine translations, then finish with SEO.')); ?>

                </p>
                <div class="car-workbench__hero-tags">
                    <span class="car-workbench__tag"><?php echo e(__('Listing refresh')); ?></span>
                    <?php if($languageCount): ?>
                        <span class="car-workbench__tag"><?php echo e(__(':count locales', ['count' => $languageCount])); ?></span>
                    <?php endif; ?>
                    <span class="car-workbench__tag"><?php echo e(__('Image manager linked')); ?></span>
                </div>
            </div>
            <div class="car-workbench__hero-cards">
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Car')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e($carDisplayName); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Current listing record')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Availability')); ?></span>
                    <strong
                        class="car-workbench__metric-value"><?php echo e($item->status === 'available' ? __('Available') : __('Not Available')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Inventory-facing state')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Visibility')); ?></span>
                    <strong
                        class="car-workbench__metric-value"><?php echo e($item->is_active ? __('Active') : __('Inactive')); ?></strong>
                    <span class="car-workbench__metric-note"><?php echo e(__('Public publishing switch')); ?></span>
                </div>
                <div class="car-workbench__metric">
                    <span class="car-workbench__metric-label"><?php echo e(__('Features')); ?></span>
                    <strong class="car-workbench__metric-value"><?php echo e($selectedFeatures); ?></strong>
                    <span
                        class="car-workbench__metric-note"><?php echo e(__('Updated :time', ['time' => $updatedAt ?: __('just now')])); ?></span>
                </div>
            </div>
        </section>
            ...
            <aside class="car-workbench__aside">
                <div class="car-workbench__panel">
                    <div class="car-workbench__panel-head">
                        ...
                        <div>
                            <h3 class="car-workbench__panel-title"><?php echo e(__('Editing Focus')); ?></h3>
                            <p class="car-workbench__panel-copy">
                                <?php echo e(__('Use the main tabs to review the listing in the order buyers and search engines depend on.')); ?>
                    ...
                    <ul class="car-workbench__steps">
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('General')); ?></span>
                            <span
                                class="car-workbench__step-text"><?php echo e(__('Audit specs, pricing, switches, and selected features.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('Translations')); ?></span>
                            <span
                                class="car-workbench__step-text"><?php echo e(__('Refresh localized copy where the message or naming changed.')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__step-label"><?php echo e(__('SEO')); ?></span>
                            <span
                                class="car-workbench__step-text"><?php echo e(__('Tighten titles, descriptions, and FAQ intent before saving.')); ?></span>
                        </li>
                    </ul>
                </div>
                <div class="car-workbench__panel">
                    <div class="car-workbench__panel-head">
                        ...
                        <div>
                            <h3 class="car-workbench__panel-title"><?php echo e(__('Quick Audit')); ?></h3>
                            <p class="car-workbench__panel-copy"><?php echo e(__('Key state checks for this specific listing.')); ?></p>
                        </div>
                    </div>
                    <ul class="car-workbench__facts">
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('Last update')); ?></span>
                            <span class="car-workbench__fact-value"><?php echo e($updatedAt ?: __('just now')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('Visibility')); ?></span>
                            <span
                                class="car-workbench__fact-value"><?php echo e($item->is_active ? __('Currently live-ready') : __('Held back from publishing')); ?></span>
                        </li>
                        <li>
                            <span class="car-workbench__fact-label"><?php echo e(__('Images')); ?></span>
                            <span
                                class="car-workbench__fact-value"><?php echo e(__('Use the image manager if gallery ordering needs to change.')); ?></span>
                        </li>
                    </ul>
                </div>
            </aside>
                ...
                <div class="card form-card card-primary card-outline card-tabs shadow-lg studio-shell-card">
                    <div class="card-header p-0 pt-1 border-bottom-0 bg-light">
                        <ul class="nav nav-tabs nav-tabs-modern" id="custom-tabs-three-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark" id="custom-tabs-seo-tab" data-bs-toggle="pill"
                                    href="#custom-tabs-seo" role="tab" aria-controls="custom-tabs-seo"
                                    aria-selected="false">
                    ...
                    <div class="card-body">
                        <form id="editCarForm" action="<?php echo e(route('admin.' . $modelName . '.update', $item->id)); ?>"
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="brand_id" id="brand_id"
                                                            ...
                                                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($brand->id); ?>" <?php echo e((old('brand_id', $item->brand_id) == $brand->id) ? 'selected' : ''); ?>>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="car_model_id" id="car_model_id"
                                                            class="form-control shadow-sm select2"
                                                            data-selected="<?php echo e(old('car_model_id', $item->car_model_id)); ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="category_id" class="font-weight-bold">Car
                                                            Categories</label>
                                                        <?php
                                                        ...
                                                        <select name="category_ids[]" id="category_id"
                                                            class="form-control shadow-sm select2 <?php $__errorArgs = ['category_ids'];
...
unset($__errorArgs, $__bag); ?> <?php $__errorArgs = ['category_ids.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($category->id); ?>" <?php echo e(in_array($category->id, $selectedCategoryIds) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="gear_type_id" id="gear_type_id"
                                                            ...
                                                            <?php $__currentLoopData = $gearTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gearType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($gearType->id); ?>" <?php echo e(old('gear_type_id', $item->gear_type_id) == $gearType->id ? 'selected' : ''); ?>>
                                                        ...
                                                        <select name="color_id" id="color_id"
                                                            ...
                                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($color->id); ?>"
                                                                    style="background-color: <?php echo e($color->color_code); ?>; color: <?php echo e($color->color_code == '#FFFFFF' ? '#000000' : '#FFFFFF'); ?>;"
                                                                    <?php echo e(old('color_id', $item->color_id) == $color->id ? 'selected' : ''); ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="year_id" id="year_id"
                                                            ...
                                                            <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($year->id); ?>" <?php echo e((string) old('year_id', $item->year_id) === (string) $year->id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status" class="form-control shadow-sm">
                                                            ...
                                                            <option value="available" <?php echo e(old('status', $item->status) == 'available' ? 'selected' : ''); ?>>Available
                                                            </option>
                                                            <option value="not_available" <?php echo e(old('status', $item->status) == 'not_available' ? 'selected' : ''); ?>>Not
                                                                Available
                                                            </option>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="door_count" class="font-weight-bold">Number of
                                                            Doors</label>
                                                        <input type="number" name="door_count"
                                                            class="form-control shadow-sm" id="door_count"
                                                            value="<?php echo e(old('door_count', $item->door_count)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="luggage_capacity" class="font-weight-bold">Number of
                                                            luggage
                                                            Capacity</label>
                                                        <input type="number" name="luggage_capacity"
                                                            class="form-control shadow-sm" id="luggage_capacity"
                                                            value="<?php echo e(old('luggage_capacity', $item->luggage_capacity)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="passenger_capacity"
                                                            class="form-control shadow-sm" id="passenger_capacity" max="20"
                                                            min="1"
                                                            value="<?php echo e(old('passenger_capacity', $item->passenger_capacity)); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="daily_main_price" class="font-weight-bold">Daily Main
                                                            Price</label>
                                                        <input type="text" name="daily_main_price"
                                                            class="form-control shadow-sm" id="daily_main_price"
                                                            value="<?php echo e(old('daily_main_price', $item->daily_main_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="daily_discount_price" class="font-weight-bold">Daily
                                                            Price With
                                                            Discount</label>
                                                        <input type="text" name="daily_discount_price"
                                                            class="form-control shadow-sm" id="daily_discount_price"
                                                            value="<?php echo e(old('daily_discount_price', $item->daily_discount_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="daily_mileage_included" class="font-weight-bold">Daily
                                                            Mileage
                                                            Included</label>
                                                        <input type="number" name="daily_mileage_included"
                                                            class="form-control shadow-sm" id="daily_mileage_included"
                                                            value="<?php echo e(old('daily_mileage_included', $item->daily_mileage_included)); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="weekly_main_price" class="font-weight-bold">Weekly Main
                                                            Price</label>
                                                        <input type="text" name="weekly_main_price"
                                                            class="form-control shadow-sm" id="weekly_main_price"
                                                            value="<?php echo e(old('weekly_main_price', $item->weekly_main_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="weekly_discount_price" class="font-weight-bold">Weekly
                                                            Price With
                                                            Discount</label>
                                                        <input type="text" name="weekly_discount_price"
                                                            class="form-control shadow-sm" id="weekly_discount_price"
                                                            value="<?php echo e(old('weekly_discount_price', $item->weekly_discount_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="weekly_mileage_included" class="font-weight-bold">Weakly
                                                            Mileage
                                                            Included</label>
                                                        <input type="number" name="weekly_mileage_included"
                                                            class="form-control shadow-sm" id="weekly_mileage_included"
                                                            value="<?php echo e(old('weekly_mileage_included', $item->weekly_mileage_included)); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="monthly_main_price" class="font-weight-bold">Monthly
                                                            Main
                                                            Price</label>
                                                        <input type="text" name="monthly_main_price"
                                                            class="form-control shadow-sm" id="monthly_main_price"
                                                            value="<?php echo e(old('monthly_main_price', $item->monthly_main_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="monthly_discount_price" class="font-weight-bold">Monthly
                                                            Price With
                                                            Discount</label>
                                                        <input type="text" name="monthly_discount_price"
                                                            class="form-control shadow-sm" id="monthly_discount_price"
                                                            value="<?php echo e(old('monthly_discount_price', $item->monthly_discount_price)); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="monthly_mileage_included"
                                                            class="font-weight-bold">Monthly Mileage
                                                            Included</label>
                                                        <input type="number" name="monthly_mileage_included"
                                                            class="form-control shadow-sm" id="monthly_mileage_included"
                                                            value="<?php echo e(old('monthly_mileage_included', $item->monthly_mileage_included)); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="insurance_included"
                                                            class="custom-control-input" id="insurance_included" <?php echo e(old('insurance_included', $item->insurance_included) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                            for="insurance_included">Insurance
                                                            Included</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="free_delivery"
                                                            class="custom-control-input" id="free_delivery" <?php echo e(old('free_delivery', $item->free_delivery) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label" for="free_delivery">Free
                                                            Delivery</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="crypto_payment_accepted"
                                                            class="custom-control-input" id="crypto_payment_accepted" <?php echo e(old('crypto_payment_accepted', $item->crypto_payment_accepted) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                            for="crypto_payment_accepted">Crypto Payment
                                                            Accepted</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="is_featured"
                                                            class="custom-control-input" id="is_featured" <?php echo e(old('is_featured', $item->is_featured) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                            for="is_featured">Add to Home Featured Cars Section</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="is_flash_sale"
                                                            class="custom-control-input" id="is_flash_sale" <?php echo e(old('is_flash_sale', $item->is_flash_sale) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label" for="is_flash_sale">Flash
                                                            Sale</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="only_on_afandina"
                                                            class="custom-control-input" id="only_on_afandina" <?php echo e(old('only_on_afandina', $item->only_on_afandina) ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label" for="only_on_afandina">Add to
                                                            Home Car Only Section</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="form-group">
                                                    <label for="features" class="font-weight-bold">Features related to
                                                        Post</label>
                                                    <select class="form-control feature-select" name="features[]"
                                                        multiple="multiple" style="width: 100%;">
                                                        <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($feature->id); ?>"
                                                                data-icon="<?php echo e($feature->icon->icon_class); ?>" <?php echo e(in_array($feature->id, $selectedFeatures) ? 'selected' : ''); ?>>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="is_active" class="custom-control-input"
                                                            id="is_active" <?php echo e(old('is_active', $item->is_active) ? 'checked' : ''); ?>>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-translated" role="tabpanel"
                                    ...
                                    <div class="card shadow-sm border-0 mb-4 studio-pane-surface">
                                        <div
                                            class="card-body d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
                                            <div class="d-flex align-items-center mb-3 mb-lg-0">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 text-muted">Choose the language you want to auto-fill.
                                                        Existing text in that language will be replaced.</p>
                                                </div>
                                            </div>
                                        ...
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php if($loop->first): ?> active <?php endif; ?> bg-light text-dark"
                                                    id="pills-<?php echo e($lang->code); ?>-tab" data-bs-toggle="pill"
                                                    href="#pills-<?php echo e($lang->code); ?>" role="tab"
                                                    aria-controls="pills-<?php echo e($lang->code); ?>"
                                                    aria-selected="true"><?php echo e($lang->name); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded studio-pane-surface"
                                        id="pills-tabContent">
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>"
                                                id="pills-<?php echo e($lang->code); ?>" role="tabpanel"
                                                aria-labelledby="pills-<?php echo e($lang->code); ?>-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name[<?php echo e($lang->code); ?>]"
                                                        ...
                                                        id="name_<?php echo e($lang->code); ?>"
                                                        value="<?php echo e(old('name.' . $lang->code, $translation->name ?? '')); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="description_<?php echo e($lang->code); ?>"
                                                ...
                                                <div class="form-group">
                                                    <label for="long_description_<?php echo e($lang->code); ?>"
                                                        class="font-weight-bold">Long
                                                        Description (<?php echo e($lang->name); ?>)</label>
                                                    <textarea name="translations[<?php echo e($lang->code); ?>][long_description]"
                                                        class="form-control form-control-lg shadow-sm tinymce"
                                                        id="long_description_<?php echo e($lang->code); ?>"
                                                        rows="6"><?php echo e(old('translations.' . $lang->code . '.long_description', $translation->long_description ?? '')); ?></textarea>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-seo" role="tabpanel"
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-seo-tab" role="tablist">
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php if($loop->first): ?> active <?php endif; ?> bg-light text-dark"
                                                    id="pills-seo-<?php echo e($lang->code); ?>-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded studio-pane-surface"
                                        ...
                                        <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>"
                                                ...
                                                <div class="form-group">
                                                    <label for="meta_title_<?php echo e($lang->code); ?>" class="font-weight-bold">Meta
                                                        Title
                                                        (<?php echo e($lang->name); ?>)</label>
                                                    <input type="text" name="meta_title[<?php echo e($lang->code); ?>]"
                                                        class="form-control form-control-lg shadow-sm"
                                                        id="meta_title_<?php echo e($lang->code); ?>"
                                                        value="<?php echo e(old('meta_title.' . $lang->code, $translation->meta_title ?? '')); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="meta_description_<?php echo e($lang->code); ?>"
                                                        class="font-weight-bold">Meta
                                                        Description (<?php echo e($lang->name); ?>)</label>
                                                ...
                                                <!-- Meta Keywords Field -->
                                                <div class="form-group">
                                                    <label for="meta_keywords_<?php echo e($lang->code); ?>" class="font-weight-bold">Meta
                                                        Keywords
                                                        (<?php echo e($lang->name); ?>)</label>
                                                    <?php
                                                    ...
                                                    <input type="text" name="meta_keywords[<?php echo e($lang->code); ?>]"
                                                        class="form-control form-control-lg shadow-sm"
                                                        id="meta_keywords_<?php echo e($lang->code); ?>"
                                                ...
                                                <div class="row studio-inline-card">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="robots_index_<?php echo e($lang->code); ?>"
                                                            ...
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="robots_index[<?php echo e($lang->code); ?>]"
                                                                    ...
                                                                    id="robots_index_<?php echo e($lang->code); ?>" value="index" <?php echo e(old('meta_title.' . $lang->code, $translation->robots_index ?? '') === 'index' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="robots_follow_<?php echo e($lang->code); ?>"
                                                                class="font-weight-bold">
                                                            ...
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="robots_follow[<?php echo e($lang->code); ?>]"
                                                                    class="custom-control-input"
                                                                    id="robots_follow_<?php echo e($lang->code); ?>" value="follow" <?php echo e(old('meta_title.' . $lang->code, $translation->robots_follow ?? '') === 'follow' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label"
                                                ...
                                                <div class="seo-questions-container" id="seo-questions-<?php echo e($lang->code); ?>">
                                                    <label class="font-weight-bold">SEO Questions/Answers
                                                        (<?php echo e($lang->name); ?>)</label>
                                                    <?php $__currentLoopData = $item->seoQuestions->where('locale', $lang->code); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $seoQuestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div
                                                            class="seo-question-group mb-3 p-3 border border-light rounded shadow-sm">
                                                            <div class="form-group">
                                                                <input type="text"
                                                            ...
                                                            <div class="form-group">
                                                                <textarea
                                                                    name="seo_questions[<?php echo e($lang->code); ?>][<?php echo e($index); ?>][answer]"
                                                                    class="form-control form-control-lg shadow-sm"
                                                                    placeholder="Enter Answer"><?php echo e(old('seo_questions.' . $lang->code . '.' . $index . '.answer', $seoQuestion->answer_text)); ?></textarea>
                                                            </div>
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger remove-question">Remove</button>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            var initialModelId = '<?php echo e(old('car_model_id', $item->car_model_id)); ?>';
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\cars\edit.blade.php ENDPATH**/ ?>