    ...
    <div class="management-hero mb-2">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p class="mb-0"><?php echo e(__('Refine fleet entries, update filters, and keep availability in sync.')); ?></p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-layer-group"></i> <?php echo e($totalCars); ?> <?php echo e(__('cars')); ?>

                </span>
                <span class="stat-pill">
                    <i class="fas fa-toggle-on"></i> <?php echo e($activeCars); ?> <?php echo e(__('active')); ?>

                </span>
                <span class="stat-pill">
                    <i class="fas fa-toggle-off"></i> <?php echo e($inactiveCars); ?> <?php echo e(__('inactive')); ?>
        ...
        $(document).ready(function () {
            ...
            if ($carsTable.length && $carsTable.find('tbody tr').length) {
                $carsTable.DataTable({
                    ...
                    language: {
                        search: "",
                        searchPlaceholder: "<?php echo e(__('Search cars')); ?>",
                        ...
                        zeroRecords: "<?php echo e(__('No matching cars found')); ?>",
                        paginate: {
