...
unset($__errorArgs, $__bag); ?>" id="name_en" value="<?php echo e(old('name_en')); ?>" placeholder="أدخل اسم <?php echo e($modelName); ?> بالإنجليزية" required>
...
unset($__errorArgs, $__bag); ?>" id="name_ar" value="<?php echo e(old('name_ar')); ?>" placeholder="أدخل اسم <?php echo e($modelName); ?> بالعربية" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="logo_path" class="custom-file-input <?php $__errorArgs = ['logo_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="logo_path" onchange="previewImage(event)">
...
unset($__errorArgs, $__bag); ?>" id="meta_title_en" value="<?php echo e(old('meta_title_en')); ?>" placeholder="أدخل العنوان التعريفي بالإنجليزية">
...
unset($__errorArgs, $__bag); ?>" id="meta_title_ar" value="<?php echo e(old('meta_title_ar')); ?>" placeholder="أدخل العنوان التعريفي بالعربية">
...
unset($__errorArgs, $__bag); ?>" id="meta_description_en" placeholder="أدخل الوصف التعريفي بالإنجليزية"><?php echo e(old('meta_description_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_description_ar" placeholder="أدخل الوصف التعريفي بالعربية"><?php echo e(old('meta_description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_keywords_en" value="<?php echo e(old('meta_keywords_en')); ?>" placeholder="أدخل الكلمات المفتاحية بالإنجليزية">
...
unset($__errorArgs, $__bag); ?>" id="meta_keywords_ar" value="<?php echo e(old('meta_keywords_ar')); ?>" placeholder="أدخل الكلمات المفتاحية بالعربية">
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\afandina\resources\views\pages\admin\old\brands\create.blade.php ENDPATH**/ ?>