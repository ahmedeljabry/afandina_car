    ...
    <div class="management-hero">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p><?php echo e(__('Storytell with confidence—control featured slots and live articles.')); ?></p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-newspaper"></i> <?php echo e($totalItems); ?> <?php echo e(__('posts')); ?>

                </span>
                <span class="stat-pill">
                    <i class="fas fa-home"></i> <?php echo e($homeItems); ?> <?php echo e(__('featured')); ?>
    ...
    <div class="card management-card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                <div>
                    <h4 class="mb-1"><?php echo e($modelName); ?> <?php echo e(__('Studio')); ?></h4>
                    <p class="text-muted mb-0"><?php echo e(__('Track thumbnails, spotlight settings, and go-live status in one spot.')); ?></p>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->image_path)); ?>" alt="<?php echo e($item->translations->first()->title ?? __('Post cover')); ?>" class="media-thumb">
                                    <?php else: ?>
                                ...
                                <td>
                                    <div class="toggle-stack">
                                        ...
                                        <span class="status-pill mt-50 <?php echo e($item->is_active ? 'active' : 'inactive'); ?>">
                                            <i class="fas <?php echo e($item->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?>"></i>
                                            <?php echo e($item->is_active ? __('Live') : __('Hidden')); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="empty-row">
                                <td colspan="6" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle mr-1"></i> <?php echo e(__('No blog posts found yet.')); ?>
    ...
    <script>
        $(function () {
            ...
            $table.DataTable({
                ...
                language: {
                    search: "",
                    searchPlaceholder: "<?php echo e(__('Search posts')); ?>",
                    ...
                    zeroRecords: "<?php echo e(__('No matching posts found')); ?>",
                    paginate: {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car_rental-src-2025-11-05\car_rental\resources\views/pages/admin/blogs/index.blade.php ENDPATH**/ ?>