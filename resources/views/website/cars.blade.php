...
@section('content')
    <?php
        ...
        $showListingContent = $listingContentTitle !== '' || $listingContentDescription !== '' || $listingContentArticle !== '';
        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title"><?php echo e($pageHeading); ?></h2>
                ...
                <div class="col-12">
                    ...
                    <?php if($showListingContent): ?>
                        <div class="listing-seo-content">
                            <?php if($listingContentTitle !== ''): ?>
                                <h2><?php echo e($listingContentTitle); ?></h2>
                            <?php endif; ?>

                            <?php if($listingContentDescription !== ''): ?>
