...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title">{{ $aboutMainTitle }}</h2>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="about-img">
                        <div class="about-exp">
                            <span>{{ __('website.about.badge_active_cars', ['count' => number_format($carsCount)]) }}</span>
                        </div>
                        <div class="abt-img">
                            <img src="{{ $aboutData['why_choose_image_url'] ?? $assetUrl('img/about-us.png') }}" class="img-fluid" alt="{{ $aboutMainTitle }}">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="about-content">
                        <h6>{{ $aboutAgencyTitle }}</h6>
                        <h2>{{ $aboutMainTitle }}</h2>
                        <p>{{ $mainParagraph }}</p>
                        <p>{{ $ourVisionContent }}</p>
                        <div class="row">
                            <div class="col-md-6">
                                <ul>
                                    <li>{{ $whyChooseTitle }}</li>
                                    <li>{{ $ourVisionTitle }}</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li>{{ $ourMissionTitle }}</li>
                                    <li>{{ __('website.about.stats_locations', ['count' => number_format($locationsCount)]) }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section services bg-light-primary">
        <div class="service-right">
            <img src="{{ $assetUrl('img/bg/service-right.svg') }}" class="img-fluid" alt="services right">
        </div>
        <div class="container">
            <!-- Heading title-->
                    ...
                    <div class="col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="services-group">
                            <div class="services-icon border-secondary">
                                <img class="icon-img bg-secondary" src="{{ $assetUrl('img/icons/services-icon-01.svg') }}" alt="Choose Locations">
                            </div>
                            <div class="services-content">
                                <h3>1. {{ __('website.home.rental.step1_title') }}</h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="services-group">
                            <div class="services-icon border-warning">
                                <img class="icon-img bg-warning" src="{{ $assetUrl('img/icons/services-icon-02.svg') }}" alt="Pick-Up Locations">
                            </div>
                            <div class="services-content">
                                <h3>2. {{ __('website.home.rental.step2_title') }}</h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="services-group">
                            <div class="services-icon border-dark">
                                <img class="icon-img bg-dark" src="{{ $assetUrl('img/icons/services-icon-03.svg') }}" alt="Book your Car">
                            </div>
                            <div class="services-content">
                                <h3>3. {{ __('website.home.rental.step3_title') }}</h3>
    ...
    <section class="section facts-number">
        <div class="facts-left">
            <img src="{{ $assetUrl('img/bg/facts-left.png') }}" class="img-fluid" alt="facts left">
        </div>
        <div class="facts-right">
            <img src="{{ $assetUrl('img/bg/facts-right.png') }}" class="img-fluid" alt="facts right">
        </div>
        <div class="container">
            <!-- Heading title-->
            <div class="section-heading" data-aos="fade-down">
                <h2 class="title text-white">{{ __('website.about.facts.title') }}</h2>
                <p class="description text-white">{{ __('website.about.facts.paragraph') }}</p>
            </div>
            <!-- /Heading title -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                        <div class="count-group flex-fill">
                            <div class="customer-count d-flex align-items-center">
                                <div class="count-img">
                                    <img src="{{ $assetUrl('img/icons/bx-heart.svg') }}" alt="Icon">
                                </div>
                                <div class="count-content">
                                    <h4><span class="counterUp">{{ $brandsCount }}</span>+</h4>
                                    <p>{{ __('website.about.facts.active_brands') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                        <div class="count-group flex-fill">
                            <div class="customer-count d-flex align-items-center">
                                <div class="count-img">
                                    <img src="{{ $assetUrl('img/icons/bx-car.svg') }}" alt="Icon">
                                </div>
                                <div class="count-content">
                                    <h4><span class="counterUp">{{ $carsCount }}</span>+</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                        <div class="count-group flex-fill">
                            <div class="customer-count d-flex align-items-center">
                                <div class="count-img">
                                    <img src="{{ $assetUrl('img/icons/bx-headphone.svg') }}" alt="Icon">
                                </div>
                                <div class="count-content">
                                    <h4><span class="counterUp">{{ $locationsCount }}</span>+</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                        <div class="count-group flex-fill">
                            <div class="customer-count d-flex align-items-center">
                                <div class="count-img">
                                    <img src="{{ $assetUrl('img/icons/bx-history.svg') }}" alt="Icon">
                                </div>
                                <div class="count-content">
                                    <h4><span class="counterUp">{{ $categoriesCount }}</span>+</h4>
                                    <p>{{ __('website.about.facts.active_categories') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section why-choose">
        <div class="choose-left">
            <img src="{{ $aboutData['our_mission_image_url'] ?? $assetUrl('img/bg/choose-left.png') }}" class="img-fluid" alt="Why Choose Us">
        </div>
        <div class="container">
            <!-- Heading title-->
            <div class="section-heading" data-aos="fade-down">
                <h2>{{ $whyChooseTitle }}</h2>
                <p>{{ $whyChooseContent }}</p>
            </div>
            <!-- /Heading title -->
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="choose-img choose-black">
                                    <img src="{{ $assetUrl('img/icons/bx-selection.svg') }}" alt="Icon">
                                </div>
                                <div class="choose-content">
                                    <h4>{{ $whyChooseTitle }}</h4>
                                    <p>{{ $whyChooseContent }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="choose-img choose-secondary">
                                    <img src="{{ $assetUrl('img/icons/bx-crown.svg') }}" alt="Icon">
                                </div>
                                <div class="choose-content">
                                    <h4>{{ $ourVisionTitle }}</h4>
                                    <p>{{ $ourVisionContent }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="choose-img choose-primary">
                                    <img src="{{ $assetUrl('img/icons/bx-user-check.svg') }}" alt="Icon">
                                </div>
                                <div class="choose-content">
                                    <h4>{{ $ourMissionTitle }}</h4>
                                    <p>{{ $ourMissionContent }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section about-testimonial testimonials-section">
        <div class="container">
            <!-- Heading title-->
            <div class="section-heading" data-aos="fade-down">
                <h2 class="title text-white">{{ __('website.home.testimonials.title') }}</h2>
                <p class="description text-white">{{ __('website.home.testimonials.paragraph') }}</p>
            </div>
            <!-- /Heading title -->
                            ...
                            <div class="review-box">
                                <div class="review-profile">
                                    <div class="review-img">
                                        <img src="{{ $assetUrl('img/profiles/avatar-02.jpg') }}" class="img-fluid" alt="img">
                                    </div>
                                </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="review-box">
                                <div class="review-profile">
                                    <div class="review-img">
                                        <img src="{{ $assetUrl('img/profiles/avatar-03.jpg') }}" class="img-fluid" alt="img">
                                    </div>
                                </div>
                                <div class="review-details">
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="review-box">
                                <div class="review-profile">
                                    <div class="review-img">
                                        <img src="{{ $assetUrl('img/profiles/avatar-04.jpg') }}" class="img-fluid" alt="img">
                                    </div>
                                </div>
                                <div class="review-details">
    ...
    <section class="section faq-section bg-light-primary">
        <div class="container">
            <!-- Heading title-->
            <div class="section-heading" data-aos="fade-down">
                <h2>{{ __('website.home.sections.faq_title') }}</h2>
                <p>{{ __('website.home.sections.faq_paragraph') }}</p>
            </div>
            <!-- /Heading title -->
            <div class="faq-info">
                @forelse ($faqs as $faqIndex => $faq)
                    ...
                    <div class="faq-card bg-white" data-aos="fade-down">
                        <h4 class="faq-title">
                            <a class="{{ $faqIndex > 0 ? 'collapsed' : '' }}" data-bs-toggle="collapse" href="#{{ $faqId }}" aria-expanded="{{ $faqIndex === 0 ? 'true' : 'false' }}">
                                {{ $faq['question'] }}
                            </a>
                        </h4>
                ...
                @empty
                    <div class="faq-card bg-white" data-aos="fade-down">
                        <h4 class="faq-title">{{ __('website.about.no_faqs_title') }}</h4>
