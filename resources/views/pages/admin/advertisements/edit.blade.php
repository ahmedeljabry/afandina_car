                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="custom-file">
                                <input type="file" name="web_image_path"
                                    class="custom-file-input image-upload @error('web_image_path') is-invalid @enderror"
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="custom-file">
                                <input type="file" name="mobile_image_path"
                                    class="custom-file-input image-upload @error('mobile_image_path') is-invalid @enderror"
