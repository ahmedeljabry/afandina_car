                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->mobile_image_path)
                                                <img src="{{ asset('storage/' . $item->mobile_image_path) }}" alt="Brand Logo" style="width: 200px; height: 100px; object-fit: cover;">
                                            @else
                                                <span>N/A</span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($item->web_image_path)
                                                <img src="{{ asset('storage/' . $item->web_image_path) }}" alt="Brand Logo"  style="width: 200px; height: 100px; object-fit: cover;">
                                            @else
                                                <span>N/A</span>
                                            @endif
                                        </td>
                                        <td>{{ $item->translations->first()->title ?? 'N/A' }}</td>
                                        <td>{{ $item->advertisementPosition->position_name ?? 'N/A' }}</td>
                                        <td>
