                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="general_field" class="form-control form-control-lg shadow-sm"
                                id="general_field" value="{{ old('general_field') }}">
                        </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="custom-file">
                                <input type="file" name="logo_path"
                                    class="custom-file-input image-upload @error('logo_path') is-invalid @enderror"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="robots_index[{{ $lang->code }}]"
                                                        ...
                                                        value="index" {{ old('robots_index.' . $lang->code, $currentValues['robots_index'][$lang->code] ?? '') === 'index' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="robots_follow[{{ $lang->code }}]"
                                                        ...
                                                        value="follow" {{ old('robots_follow.' . $lang->code, $currentValues['robots_follow'][$lang->code] ?? '') === 'follow' ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
