        ...
        <section class="car-workbench__hero">
            ...
            <div class="car-workbench__hero-cards">
                ...
                <div class="car-workbench__metric">
                    ...
                    <strong
                        class="car-workbench__metric-value">{{ $item->status === 'available' ? __('Available') : __('Not Available') }}</strong>
                ...
                <div class="car-workbench__metric">
                    ...
                    <strong
                        class="car-workbench__metric-value">{{ $item->is_active ? __('Active') : __('Inactive') }}</strong>
                ...
                <div class="car-workbench__metric">
                    ...
                    <span
                        class="car-workbench__metric-note">{{ __('Updated :time', ['time' => $updatedAt ?: __('just now')]) }}</span>
                </div>
            </div>
        </section>
        ...
        <div class="car-workbench__layout">
            ...
            <div class="car-workbench__main">
                ...
                <div class="card form-card card-primary card-outline card-tabs shadow-lg studio-shell-card">
                    ...
                    <div class="card-body">
                        <form id="editCarForm" action="{{ route('admin.' . $modelName . '.update', $item->id) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_ids[]" id="category_id"
                                                            class="form-control shadow-sm select2 @error('category_ids') is-invalid @enderror @error('category_ids.*') is-invalid @enderror"
                                                            multiple="multiple">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status" class="form-control shadow-sm">
                                                            ...
                                                            <option value="not_available" {{ old('status', $item->status) == 'not_available' ? 'selected' : '' }}>Not
                                                                Available
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="door_count"
                                                            ...
                                                            value="{{ old('door_count', $item->door_count) }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="insurance_included"
                                                            class="custom-control-input" id="insurance_included" {{ old('insurance_included', $item->insurance_included) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="free_delivery"
                                                            class="custom-control-input" id="free_delivery" {{ old('free_delivery', $item->free_delivery) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="is_flash_sale"
                                                            class="custom-control-input" id="is_flash_sale" {{ old('is_flash_sale', $item->is_flash_sale) ? 'checked' : '' }}>
                                                    ...
                                                    <select class="form-control feature-select" name="features[]"
                                                        ...
                                                        @foreach($features as $feature)
                                                            <option value="{{ $feature->id }}"
                                                                data-icon="{{ $feature->icon->icon_class }}" {{ in_array($feature->id, $selectedFeatures) ? 'selected' : '' }}>
                                        ...
                                        @foreach($activeLanguages as $lang)
                                            <li class="nav-item">
                                                <a class="nav-link @if($loop->first) active @endif bg-light text-dark"
                                                    id="pills-{{ $lang->code }}-tab" data-bs-toggle="pill"
                                                    href="#pills-{{ $lang->code }}" role="tab"
                                                    aria-controls="pills-{{ $lang->code }}"
                                    ...
                                    <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded studio-pane-surface"
                                        ...
                                        @foreach($activeLanguages as $lang)
                                            ...
                                            <div class="tab-pane fade @if($loop->first) show active @endif"
                                                id="pills-{{ $lang->code }}" role="tabpanel"
                                                aria-labelledby="pills-{{ $lang->code }}-tab">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="long_description_{{ $lang->code }}"
                                    ...
                                    <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded studio-pane-surface"
                                        ...
                                        @foreach($activeLanguages as $lang)
                                            ...
                                            <div class="tab-pane fade @if($loop->first) show active @endif"
                                                ...
                                                <div class="form-group">
                                                    <label for="meta_title_{{ $lang->code }}" class="font-weight-bold">Meta
                                                        Title
                                                        ({{ $lang->name }})</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="meta_description_{{ $lang->code }}"
                                                ...
                                                <!-- Meta Keywords Field -->
                                                <div class="form-group">
                                                    <label for="meta_keywords_{{ $lang->code }}" class="font-weight-bold">Meta
                                                        Keywords
                                                        ({{ $lang->name }})</label>
                                                    @php
                                                ...
                                                <div class="row studio-inline-card">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="robots_index_{{ $lang->code }}"
                                                            ...
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="robots_index[{{ $lang->code }}]"
                                                                    ...
                                                                    id="robots_index_{{ $lang->code }}" value="index" {{ old('meta_title.' . $lang->code, $translation->robots_index ?? '') === 'index' ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="robots_follow_{{ $lang->code }}"
                                                                class="font-weight-bold">
                                                            ...
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="robots_follow[{{ $lang->code }}]"
                                                                    class="custom-control-input"
                                                                    id="robots_follow_{{ $lang->code }}" value="follow" {{ old('meta_title.' . $lang->code, $translation->robots_follow ?? '') === 'follow' ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
