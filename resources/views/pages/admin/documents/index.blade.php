    ...
    <div class="management-hero">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                ...
                <p>{{ __('Keep compliance-ready checklists organized for every request.') }}</p>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="stat-pill">
                    <i class="fas fa-file-alt"></i> {{ $totalItems }} {{ __('records') }}
                </span>
                <span class="stat-pill">
    ...
    <div class="card management-card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                <div>
                    <h4 class="mb-1">{{ $modelName }} {{ __('Registry') }}</h4>
                    <p class="text-muted mb-0">{{ __('Filter requirements by usage and rollout status quickly.') }}</p>
                </div>
                        ...
                        @forelse ($items as $item)
                            <tr>
                                ...
                                <td class="text-bold-600">
                                    {{ $item->translations->first()->content ?? __('N/A') }}
                                </td>
                                <td>
                        ...
                        @empty
                            <tr class="empty-row">
                                <td colspan="6" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle mr-1"></i> {{ __('No documents found yet.') }}
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
