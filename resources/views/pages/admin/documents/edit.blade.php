                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel" aria-labelledby="custom-tabs-general-tab">
                                    <select name="brand_id" id="brand_id" class="form-control form-control-lg shadow-sm">
                                        ...
                                        <option value="native" {{ $item->for == "native" ? 'selected' : '' }}>
                                            Native
                                        </option>

                                        <option value="foreign" {{ $item->for == "foreign" ? 'selected' : '' }}>
                                            Foreign
                                        </option>
                                    </select>
                                        ...
                                        @foreach($activeLanguages as $lang)
                                            ...
                                            <div class="tab-pane fade @if($loop->first) show active @endif" id="pills-{{ $lang->code }}" role="tabpanel" aria-labelledby="pills-{{ $lang->code }}-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="content[{{ $lang->code }}]" class="form-control form-control-lg shadow-sm" id="name_{{ $lang->code }}" value="{{ old('content.' . $lang->code, $translation->content ?? '') }}">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
