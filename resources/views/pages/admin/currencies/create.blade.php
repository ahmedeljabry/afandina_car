                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel" aria-labelledby="custom-tabs-general-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="symbol" class="form-control form-control-lg shadow-sm" id="general_field" value="{{ old('symbol') }}">
                                    </div>
                                    <div class="form-group">
                                    <div class="form-group">
                                        <label for="code" class="font-weight-bold">Code</label>
                                        <input type="text" name="code" class="form-control form-control-lg shadow-sm" id="code" value="{{ old('code') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exchange_rate" class="font-weight-bold">Exchange Rate</label>
                                        <input type="number" name="exchange_rate" class="form-control form-control-lg shadow-sm" id="exchange_rate" value="{{ old('exchange_rate') }}">
                                    </div>
