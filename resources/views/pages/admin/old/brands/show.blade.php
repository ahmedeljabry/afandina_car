                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->logo_path)
                                                    <img src="{{ asset('storage/' . $item->logo_path) }}" alt="Brand Logo" class="brand-logo img-thumbnail" style="max-height: 100px;">
                                                @else
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <form action="{{ route('admin.'.$modelName.'.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger" onclick="return confirm('هل أنت متأكد من حذف هذا  {{$modelName}}؟');"><i class="fas fa-trash-alt"></i> حذف</button>
                                    </form>
                                </div>
                            </div>
                        </div>
