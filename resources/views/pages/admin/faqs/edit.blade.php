                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control"
                                        value="{{ old('order', $item->order) }}" required>
                        ...
                        <div class="tab-content shadow-sm p-3 mb-4 bg-white rounded" id="pills-tabContent">
                            @foreach($activeLanguages as $lang)
                                ...
                                <div class="tab-pane fade @if($loop->first) show active @endif" id="pills-{{ $lang->code }}"
                                    ...
                                    <div class="form-group">
                                        <label for="question_{{ $lang->code }}" class="font-weight-bold">Question
                                            ({{ $lang->name }})</label>
                                        <input type="text" name="question[{{ $lang->code }}]"
                                            class="form-control form-control-lg shadow-sm" id="question_{{ $lang->code }}"
                                            value="{{ old('question.' . $lang->code, $translation->question ?? '') }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="answer[{{ $lang->code }}]"
                                            ...
                                            rows="4">{{ old('answer.' . $lang->code, $translation->answer ?? '') }}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
