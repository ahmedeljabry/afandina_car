    ...
    <div class="blog-editor-layout">
        <div>
            <div class="blog-editor-hero mb-4">
                <h2>{{ __('Publish a New Story') }}</h2>
                <p>{{ __('Build a polished post with a cleaner publishing flow, structured translations, and SEO that is ready before launch.') }}</p>
                <div class="blog-editor-hero-metrics">
                    ...
                    <span class="blog-editor-chip"><i class="fas fa-image"></i>{{ __('Cover image') }}</span>
                    <span class="blog-editor-chip"><i class="fas fa-search"></i>{{ __('SEO layered') }}</span>
                    <span class="blog-editor-chip"><i class="fas fa-car-side"></i>{{ __('Cars linked') }}</span>
                </div>
            </div>
            ...
            <form action="{{ route('admin.' . $modelName . '.store') }}" method="POST" enctype="multipart/form-data" class="blog-editor">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="blog-editor-panel h-100">
                                            ...
                                            <div class="blog-editor-preview-box mb-3">
                                                <img src="{{ $placeholderImage }}" alt="{{ __('Blog preview') }}" id="blogImagePreview">
                                            </div>
                                            <label for="image_path" class="blog-editor-label">{{ __('Upload Image') }}</label>
                                            ...
                                            @enderror
                                            <p class="blog-editor-hint mt-3 mb-0">{{ __('Choose a clean landscape image so your post looks sharp in cards, shares, and highlights.') }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="blog-editor-panel">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <p class="blog-editor-hint mt-2 mb-0">{{ __('Connect inventory so readers can move from article context directly into relevant cars.') }}</p>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="blog-editor-switch">
                                                        <div>
                                                            ...
                                                            <span>{{ __('Keep this article visible in listings and available to readers.') }}</span>
                                                        </div>
                                                        <div class="form-check form-switch m-0">
                                                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" @checked((bool) old('is_active'))>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="blog-editor-switch">
                                                        <div>
                                                            ...
                                                            <span>{{ __('Push this story into homepage editorial sections.') }}</span>
                                                        </div>
                                                        <div class="form-check form-switch m-0">
                                                            <input class="form-check-input" type="checkbox" name="show_in_home" id="show_in_home" value="1" @checked((bool) old('show_in_home'))>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade blog-editor-pane" id="blog-create-translated" role="tabpanel">
                                <div class="nav nav-pills blog-editor-langbar" role="tablist">
                                    @foreach ($activeLanguages as $lang)
                                        <button class="nav-link @if($loop->first) active @endif" type="button" data-bs-toggle="pill" data-bs-target="#blog-create-lang-{{ $lang->code }}" role="tab">
                                            {{ $lang->name }}
                                        </button>
                                    @endforeach
                                </div>
                                ...
                                <div class="tab-content">
                                    @foreach ($activeLanguages as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="blog-create-lang-{{ $lang->code }}" role="tabpanel">
                                            <div class="blog-editor-langpane">
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        <label for="title_{{ $lang->code }}" class="blog-editor-label">{{ __('Title') }} ({{ $lang->name }})</label>
                                                        <input type="text" name="title[{{ $lang->code }}]" id="title_{{ $lang->code }}" class="form-control @error('title.' . $lang->code) is-invalid @enderror" value="{{ old('title.' . $lang->code) }}">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <textarea name="description[{{ $lang->code }}]" id="description_{{ $lang->code }}" class="form-control @error('description.' . $lang->code) is-invalid @enderror" rows="4">{{ old('description.' . $lang->code) }}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <textarea name="content[{{ $lang->code }}]" id="content_{{ $lang->code }}" class="form-control tinymce @error('content.' . $lang->code) is-invalid @enderror" rows="10">{{ old('content.' . $lang->code) }}</textarea>
                            ...
                            <div class="tab-pane fade blog-editor-pane" id="blog-create-seo" role="tabpanel">
                                <div class="nav nav-pills blog-editor-langbar" role="tablist">
                                    @foreach ($activeLanguages as $lang)
                                        <button class="nav-link @if($loop->first) active @endif" type="button" data-bs-toggle="pill" data-bs-target="#blog-create-seo-lang-{{ $lang->code }}" role="tab">
                                            {{ $lang->name }}
                                        </button>
                                    @endforeach
                                </div>
                                ...
                                <div class="tab-content">
                                    @foreach ($activeLanguages as $lang)
                                        ...
                                        @endphp
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="blog-create-seo-lang-{{ $lang->code }}" role="tabpanel">
                                            <div class="blog-editor-langpane">
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        <label for="meta_title_{{ $lang->code }}" class="blog-editor-label">{{ __('Meta Title') }} ({{ $lang->name }})</label>
                                                        <input type="text" name="meta_title[{{ $lang->code }}]" id="meta_title_{{ $lang->code }}" class="form-control" value="{{ old('meta_title.' . $lang->code) }}">
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="meta_description_{{ $lang->code }}" class="blog-editor-label">{{ __('Meta Description') }} ({{ $lang->name }})</label>
                                                        <textarea name="meta_description[{{ $lang->code }}]" id="meta_description_{{ $lang->code }}" class="form-control" rows="4">{{ old('meta_description.' . $lang->code) }}</textarea>
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="meta_keywords_{{ $lang->code }}" class="blog-editor-label">{{ __('Meta Keywords') }} ({{ $lang->name }})</label>
                                                        <input type="text" name="meta_keywords[{{ $lang->code }}]" id="meta_keywords_{{ $lang->code }}" class="form-control blog-editor-meta-keywords" value="{{ old('meta_keywords.' . $lang->code) }}" placeholder="{{ __('Enter meta keywords') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="blog-editor-seo-box">
                                                            ...
                                                            <div class="form-check form-switch m-0">
                                                                <input class="form-check-input" type="checkbox" name="robots_index[{{ $lang->code }}]" id="robots_index_{{ $lang->code }}" value="index" @checked(old('robots_index.' . $lang->code) === 'index')>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="blog-editor-seo-box">
                                                            ...
                                                            <div class="form-check form-switch m-0">
                                                                <input class="form-check-input" type="checkbox" name="robots_follow[{{ $lang->code }}]" id="robots_follow_{{ $lang->code }}" value="follow" @checked(old('robots_follow.' . $lang->code) === 'follow')>
                        ...
                        <div class="blog-editor-submitbar">
                            <p>{{ __('Finish the three sections, then save the post when the content and SEO are aligned.') }}</p>
        ...
        <div class="card blog-editor-sidecard">
            <div class="card-body">
                ...
                <div class="blog-editor-preview-box mb-3">
                    <img src="{{ $placeholderImage }}" alt="{{ __('Sidebar preview') }}" id="blogImagePreviewMirror">
                </div>
                <div class="blog-editor-checklist">
                    <div class="blog-editor-checklist-item">
                        <i class="fas fa-image"></i>
                        <div>
                            <strong>{{ __('Cover First') }}</strong>
                            <span>{{ __('Use a strong image before writing so the article has a clear visual anchor.') }}</span>
                        </div>
                    </div>
                    <div class="blog-editor-checklist-item">
                        <i class="fas fa-language"></i>
                        <div>
                            <strong>{{ __('Every Locale') }}</strong>
                            <span>{{ __('Complete title, description, and content for each active language.') }}</span>
                        </div>
                    </div>
                    <div class="blog-editor-checklist-item">
                        <i class="fas fa-search"></i>
                        <div>
                            <strong>{{ __('Search Signals') }}</strong>
                            <span>{{ __('Layer meta fields, robots settings, and question blocks to improve discovery.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
